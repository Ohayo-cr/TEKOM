...
import ru.ohayo.weather_tekom.data.remote.models.WeatherModelStub
import ru.ohayo.weather_tekom.ui.navigation.Screen
import ru.ohayo.weather_tekom.ui.screen.weather.component.PullRefreshSample
import ru.ohayo.weather_tekom.ui.screen.weather.component.formatDateToRelative
...
@Composable
fun WeatherDetails( cityName: String,data: WeatherModel,key: Any,
                    clickBottom: () -> Unit,clickImHere: () -> Unit,
                   isCityFavorite: Boolean, weatherResult: NetworkResponse<WeatherModel> ) {
        ...
        Row(
            ...
            Box(
                ...
                Row(
                    ...
                    Text(
                        text = if (isCityFavorite) "Вы тут" else "Я тут",
                        color = MaterialTheme.colorScheme.outline,
                        fontSize = 14.sp,
    ...
    fun ForecastItem(dayData: ForecastDay) {
        ...
        Row(
            ...
            Row {
                Text(
                    text = "${dayData.day.maxtemp_c.toInt()}°",
                    fontSize = 20.sp,
                ...
                Text(
                    text = "${dayData.day.mintemp_c.toInt().toString().padStart(2, ' ')}°",
                    fontSize = 20.sp,
                    color = Color.Gray,
                    modifier = Modifier.width(60.dp),
                    textAlign = TextAlign.Center
